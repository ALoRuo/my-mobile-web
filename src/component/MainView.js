        ...
        return(
            <div style={{height:window.innerHeight}} className='mainview'>
                ...
                <div className="bottom-tab">
                    <div className='tab-item' onClick={()=>this.changeTab('home')}><i className='iconfont icon-shouye' style={{fontSize:21,color:window.location.hash === '#/' ? '#33A3F4':'#949494'}}/><p style={{color:window.location.hash === '#/home' ? '#33A3F4':'#666'}}>首页</p></div>
